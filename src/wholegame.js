...
TotalScore = 0; // Total score across multiple games
...
function updatePointBallsForDifficulty(diff) {
    ...
    CONFIG.pointballs.forEach(ball => {
        ...
        // Optional: You can also change colors based on difficulty if you want
        /*
        if (diff === 1) ball.displayColor = ball.color;
        else if (diff === 2) ball.displayColor = '#00ff00'; // Green for intermediate
        else if (diff === 3) ball.displayColor = '#ff8800'; // Orange for hard
        else if (diff === 4) ball.displayColor = '#ff0000'; // Red for very hard
        */
    });
